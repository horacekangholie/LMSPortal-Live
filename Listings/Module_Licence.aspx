<%@ Page Title="LMSPortal - Module Licence" 
    Language="VB" 
    MasterPageFile="~/MasterPages/Frontend.master" 
    AutoEventWireup="false" CodeFile="Module_Licence.aspx.vb" 
    Inherits="Listings_Module_Licence" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            BlockUI("<%=pnlUpdateModuleLicence.ClientID %>");
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" Runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlUpdateModuleLicence" runat="server" CssClass="modalPopup">
                <h3 style="padding: 10px 0px 20px 20px"><asp:Label ID="ModalHeaderModuleLicence" runat="server"></asp:Label></h3>
                <table border="0" class="modalPopupTable" style="width: 100%">
                    <tr style="vertical-align: top">
                        <td style="width: 400px; padding: 0px 10px 20px 0px">
                            ...
                            <asp:TextBox ID="TB_UID" runat="server" Visible="false"></asp:TextBox><!--Hiddenfield-->
                        ...
                        <td style="width: 400px; padding: 0px 10px 20px 0px">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredField_TB_SO_No" runat="server" ValidationGroup="ModuleLicence"
                    ...
                    <tr style="vertical-align: top">
                        <td style="width: 400px; padding: 0px 10px 20px 0px">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredField_TB_Invoice_No" runat="server" ValidationGroup="ModuleLicence"
                                ErrorMessage="This field cannot be blank" CssClass="invalid-feedback"
                                Display="Dynamic"
                                SetFocusOnError="True"
                        ...
                        <td style="width: 400px; padding: 0px 10px 20px 0px">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredField_TB_Invoice_Date" runat="server" ValidationGroup="ModuleLicence"
                                ErrorMessage="This field cannot be blank" CssClass="invalid-feedback"
                                Display="Dynamic"
                                SetFocusOnError="True"
                    ...
                    <tr style="vertical-align: bottom">
                        <td style="width: 800px; padding: 10px 10px 10px 0px" colspan="2">
                            <asp:Button ID="btnUpdateModuleLicence" runat="server" CssClass="btn btn-sm btn-default" ValidationGroup="ModuleLicence" />
            ...
            <cc1:ModalPopupExtender ID="popupModuleLicence" runat="server" DropShadow="false"
                PopupControlID="pnlUpdateModuleLicence" TargetControlID="lnkFakeModuleLicence"
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="btnUpdateModuleLicence" />
        </Triggers>
    </asp:UpdatePanel>
