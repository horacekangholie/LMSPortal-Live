<%@ Page Title="LMSPortal - DMC Subscription" 
    Language="VB" 
    MasterPageFile="~/MasterPages/Frontend.master" 
    AutoEventWireup="false" 
    CodeFile="DMC_Subscription.aspx.vb" 
    Inherits="Listings_DMC_Subscription" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            BlockUI("<%=pnlUpdateSubscription.ClientID %>");
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" Runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlUpdateSubscription" runat="server" CssClass="modalPopup">
                ...
                <table border="0" class="modalPopupTable" style="width: 100%">
                    <tr style="vertical-align: top">
                        <td style="width: 800px; padding: 0px 10px 20px 0px" colspan="2">
                            ...
                            <asp:TextBox ID="TB_Subscription_ID" runat="server" CssClass="form-control disabled" Enabled="false"></asp:TextBox>
                        </td>
                    </tr>
                    <tr style="vertical-align: top">
                        <td style="width: 400px; padding: 0px 10px 20px 0px">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredField_TB_Invoice_No" runat="server" ValidationGroup="Subscription"
                                ErrorMessage="This field cannot be blank" CssClass="invalid-feedback"
                                Display="Dynamic"
                                SetFocusOnError="True"
                                ControlToValidate="TB_Invoice_No">
                            </asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegEx_TB_Invoice_No" runat="server" ValidationGroup="Subscription"
                        ...
                        <td style="width: 400px; padding: 0px 10px 20px 0px">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredField_TB_Invoice_Date" runat="server" ValidationGroup="Subscription"
                                ErrorMessage="This field cannot be blank" CssClass="invalid-feedback"
                                Display="Dynamic"
                                SetFocusOnError="True"
            ...
            <cc1:ModalPopupExtender ID="popupSubscription" runat="server" DropShadow="false"
                PopupControlID="pnlUpdateSubscription" TargetControlID="lnkFakeSubscription"
