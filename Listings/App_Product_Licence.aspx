<%@ Page Title="LMSPortal - App / Product Licence" 
    Language="VB" 
    MasterPageFile="~/MasterPages/Frontend.master" 
    AutoEventWireup="false" 
    CodeFile="App_Product_Licence.aspx.vb" 
    Inherits="Listings_App_Product_Licence" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            BlockUI("<%=pnlUpdateAppProductLicence.ClientID %>");
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" Runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlUpdateAppProductLicence" runat="server" CssClass="modalPopup">
                <h3 style="padding: 10px 0px 20px 20px"><asp:Label ID="ModalHeaderAppProductLicence" runat="server"></asp:Label></h3>
                <table border="0" class="modalPopupTable" style="width: 100%">
                    <tr style="vertical-align: top">
                        ...
                        <td style="width: 400px; padding: 0px 10px 20px 0px">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredField_TB_SO_No" runat="server" ValidationGroup="AppProductLicence"
                                ErrorMessage="This field cannot be blank" CssClass="invalid-feedback"
                                Display="Dynamic"
                                SetFocusOnError="True"
                                ControlToValidate="TB_SO_No">
                            </asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegEx_TB_SO_No" runat="server" ValidationGroup="AppProductLicence"
                    ...
                    <tr style="vertical-align: top">
                        <td style="width: 400px; padding: 0px 10px 20px 0px">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredField_TB_Invoice_No" runat="server" ValidationGroup="AppProductLicence"
                                ErrorMessage="This field cannot be blank" CssClass="invalid-feedback"
                                Display="Dynamic"
                                SetFocusOnError="True"
                        ...
                        <td style="width: 400px; padding: 0px 10px 20px 0px">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredField_TB_Invoice_Date" runat="server" ValidationGroup="AppProductLicence"
                                ErrorMessage="This field cannot be blank" CssClass="invalid-feedback"
                                Display="Dynamic"
                                SetFocusOnError="True"
                    ...
                    <tr style="vertical-align: bottom">
                        <td style="width: 800px; padding: 10px 10px 10px 0px" colspan="2">
                            <asp:Button ID="btnUpdateAppProductLicence" runat="server" CssClass="btn btn-sm btn-default" ValidationGroup="AppProductLicence" />
            ...
            <cc1:ModalPopupExtender ID="popupAppProductLicence" runat="server" DropShadow="false"
                PopupControlID="pnlUpdateAppProductLicence" TargetControlID="lnkFakeAppProductLicence"
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="btnUpdateAppProductLicence" />
        </Triggers>
    </asp:UpdatePanel>
