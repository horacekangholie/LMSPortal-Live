<%@ Page Title="LMSPortal - AI Licence Renewal" 
    Language="VB" 
    MasterPageFile="~/MasterPages/Frontend.master" 
    AutoEventWireup="false" 
    CodeFile="AI_Licence_Renewal.aspx.vb" 
    Inherits="Listings_AI_Licence_Renewal" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            BlockUI("<%=pnlUpdateAILicenceRenewal.ClientID %>");
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" Runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlUpdateAILicenceRenewal" runat="server" CssClass="modalPopup">
                <h3 style="padding: 10px 0px 20px 20px"><asp:Label ID="ModalHeaderAILicenceRenewal" runat="server"></asp:Label></h3>
                <table border="0" class="modalPopupTable" style="width: 100%">
                    <tr style="vertical-align: top">
                        ...
                        <td style="width: 50%; padding: 0px 10px 20px 0px">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredField_TB_SO_No" runat="server" ValidationGroup="AILicenceRenewal"
                    ...
                    <tr style="vertical-align: top">
                        <td style="width: 50%; padding: 0px 10px 20px 0px">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredField_TB_Invoice_No" runat="server" ValidationGroup="AILicenceRenewal"
                                ErrorMessage="This field cannot be blank" CssClass="invalid-feedback"
                                Display="Dynamic"
                                SetFocusOnError="True"
                        ...
                        <td style="width: 50%; padding: 0px 10px 20px 0px">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredField_TB_Invoice_Date" runat="server" ValidationGroup="AILicenceRenewal"
                                ErrorMessage="This field cannot be blank" CssClass="invalid-feedback"
                                Display="Dynamic"
                                SetFocusOnError="True"
                    ...
                    <tr style="vertical-align: bottom">
                        <td style="width: 800px; padding: 10px 10px 10px 0px" colspan="2">
                            <asp:Button ID="btnUpdateAILicenceRenewal" runat="server" CssClass="btn btn-sm btn-default" ValidationGroup="AILicenceRenewal" />
                            <asp:Button ID="btnCancelAILIcenceRenewal" runat="server" CssClass="btn btn-sm btn-default" CausesValidation="false" OnClientClick="return Hidepopup()" />
                        </td>
                    </tr>
                </table>
            </asp:Panel>

            <asp:LinkButton ID="lnkFakeAILicenceRenewal" runat="server"></asp:LinkButton>
            <cc1:ModalPopupExtender ID="popupAILicenceRenewal" runat="server" DropShadow="false"
                PopupControlID="pnlUpdateAILicenceRenewal" TargetControlID="lnkFakeAILicenceRenewal"
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="btnUpdateAILicenceRenewal" />
        </Triggers>
